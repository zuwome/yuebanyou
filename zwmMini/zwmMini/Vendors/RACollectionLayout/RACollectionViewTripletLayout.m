...
- (CGFloat)contentHeight
{
    ...
    for (NSInteger i = 0; i < numberOfSections; i++) {
        ...
        CGFloat lineHeight = numberOfLines * (largeCellHeight + lineSpacing) - lineSpacing - lastSmallCellHeight;
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.item % 6) {
        ...
        case 3:
            ...
            break;
        case 4:
            attribute.frame = CGRectMake(rightSideLargeCellOriginX, lineOriginY, _smallCellSize.width, _smallCellSize.height);
            break;
        case 5:
            attribute.frame = CGRectMake(rightSideSmallCellOriginX, lineOriginY, _smallCellSize.width, _smallCellSize.height);
            break;
