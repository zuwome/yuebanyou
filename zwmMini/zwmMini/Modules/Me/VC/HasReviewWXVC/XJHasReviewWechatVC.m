...
@interface XJHasReviewWechatVC ()<UITableViewDelegate,UITableViewDataSource,XJHasReviewTbCellDelegate>
...
@implementation XJHasReviewWechatVC
...
- (void)getHasreviewList{
    ...
    [AskManager GET:API_HAS_LOOK_WX_LIST_GET dict:@{@"sort_value":self.sortValue}.mutableCopy succeed:^(id data, XJRequestError *rError) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    XJHasReviewTbTaCell *cell = [tableView dequeueReusableCellWithIdentifier:myTableviewIdentifier];
    if (cell == nil) {
        cell = [[XJHasReviewTbTaCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:myTableviewIdentifier];
    }
    if (self.listArray.count > 0) {
        cell.delegate = self;
