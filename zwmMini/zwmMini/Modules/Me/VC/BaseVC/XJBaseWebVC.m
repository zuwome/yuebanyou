...
@interface XJBaseWebVC ()<WKNavigationDelegate, WKUIDelegate, UINavigationControllerDelegate, UINavigationBarDelegate>
...
- (UIBarButtonItem*)customBackBarItem{
    if (!_customBackBarItem) {
        ...
        [backButton setTitleColor:RGB(33, 33, 33) forState:UIControlStateNormal];
        [backButton setTitleColor:[RGB(33, 33, 33) colorWithAlphaComponent:0.5] forState:UIControlStateHighlighted];
